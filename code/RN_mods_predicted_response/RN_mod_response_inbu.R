...
saveRDS(rn_model_t_inbu, file = "data/rn_model_files/rn_model_t_inbu.rds") 
...
models_list_inbu <- list(rn_model_t_inbu = rn_model_t_inbu, rn_model_inbu = rn_model_inbu, rn_model_null_inbu = rn_model_null_inbu)
model_names_inbu <- c("Treatment Model", "Non-treatment Model", "Null Model")
...
gof <- mb.gof.test(rn_model_t_inbu, nsim=100, c.hat.est=TRUE, model.type="royle-nichols")
...
write.csv(newdata_inbu, file = "data/means_treatment_parameters_inbu.csv", row.names = FALSE)
...
dir.create("figures/predicted_abundance/mine/inbu")
ggsave("figures/predicted_abundance/mine/inbu/mine_grass_cover_inbu.png", width = 4, height = 4)
...
dir.create("figures/predicted_abundance/timber/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/timber/inbu/timber_grass_cover_inbu.png", width = 4, height = 4)
...
dir.create("figures/predicted_abundance/rx_fire_young/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_young/inbu/rx_fire_young_grass_cover_inbu.png", width = 4, height = 5)
...
dir.create("figures/predicted_abundance/rx_fire_sec_growth/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_sec_growth/inbu/rx_fire_sec_growth_grass_cover_inbu.png", width = 4, height = 4)


#repeat for shrub cover
shrub_cover_range <- seq(min(umf_inbu@siteCovs$shrub_cover), max(umf_inbu@siteCovs$shrub_cover), length.out = 100)

newdata_shrub_cover <- data.frame(
  treatment = factor(treatment_levels, levels = treatment_levels),
  shrub_cover = shrub_cover_range,
  grass_cover = mean(umf_inbu@siteCovs$grass_cover),
  forb_cover = mean(umf_inbu@siteCovs$forb_cover),
  grass_height = mean(umf_inbu@siteCovs$grass_height),
  shrub_height = mean(umf_inbu@siteCovs$shrub_height)
)

predictions_shrub_cover <- predict(rn_model_t_inbu, newdata_shrub_cover, type = "state")
...
#save to figures/predicted_abundance/mine
dir.create("figures/predicted_abundance/mine/inbu")
ggsave("figures/predicted_abundance/mine/inbu/mine_shrub_cover_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/timber
dir.create("figures/predicted_abundance/timber/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/timber/inbu/timber_shrub_cover_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_young
dir.create("figures/predicted_abundance/rx_fire_young/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_young/inbu/rx_fire_young_shrub_cover_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_sec_growth
dir.create("figures/predicted_abundance/rx_fire_sec_growth/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_sec_growth/inbu/rx_fire_sec_growth_shrub_cover_inbu.png", width = 4, height = 4)

#repeat for forb cover

forb_cover_range <- seq(min(umf_inbu@siteCovs$forb_cover), max(umf_inbu@siteCovs$forb_cover), length.out = 100)
...
predictions_forb_cover <- predict(rn_model_t_inbu, newdata_forb_cover, type = "state")
...
#save to figures/predicted_abundance/mine
dir.create("figures/predicted_abundance/mine/inbu")
ggsave("figures/predicted_abundance/mine/inbu/mine_forb_cover_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/timber
dir.create("figures/predicted_abundance/timber/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/timber/inbu/timber_forb_cover_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_young
dir.create("figures/predicted_abundance/rx_fire_young/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_young/inbu/rx_fire_young_forb_cover_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_sec_growth
dir.create("figures/predicted_abundance/rx_fire_sec_growth/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_sec_growth/inbu/rx_fire_sec_growth_forb_cover_inbu.png", width = 4, height = 4)

#repeat for shrub height

shrub_height_range <- seq(min(umf_inbu@siteCovs$shrub_height), max(umf_inbu@siteCovs$shrub_height), length.out = 100)
...
predictions_shrub_height <- predict(rn_model_t_inbu, newdata_shrub_height, type = "state")
...
#save to figures/predicted_abundance/mine
dir.create("figures/predicted_abundance/mine/inbu")
ggsave("figures/predicted_abundance/mine/inbu/mine_shrub_height_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/timber
dir.create("figures/predicted_abundance/timber/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/timber/inbu/timber_shrub_height_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_young
dir.create("figures/predicted_abundance/rx_fire_young/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_young/inbu/rx_fire_young_shrub_height_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_sec_growth
dir.create("figures/predicted_abundance/rx_fire_sec_growth/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_sec_growth/inbu/rx_fire_sec_growth_shrub_height_inbu.png", width = 4, height = 4)


# Repeat for grass height

grass_height_range <- seq(min(umf_inbu@siteCovs$grass_height), max(umf_inbu@siteCovs$grass_height), length.out = 100)
...
predictions_grass_height <- predict(rn_model_t_inbu, newdata_grass_height, type = "state")
...
#save to figures/predicted_abundance/mine
dir.create("figures/predicted_abundance/mine/inbu")
ggsave("figures/predicted_abundance/mine/inbu/mine_grass_height_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/timber
dir.create("figures/predicted_abundance/timber/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/timber/inbu/timber_grass_height_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_young
dir.create("figures/predicted_abundance/rx_fire_young/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_young/inbu/rx_fire_young_grass_height_inbu.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_sec_growth
dir.create("figures/predicted_abundance/rx_fire_sec_growth/inbu", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_sec_growth/inbu/rx_fire_sec_growth_grass_height_inbu.png", width = 4, height = 4)
