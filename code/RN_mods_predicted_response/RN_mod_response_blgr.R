...
gof <- mb.gof.test(rn_model_t_blgr, nsim=100, c.hat.est=TRUE, model.type="royle-nichols")
...
write.csv(newdata_blgr, file = "data/means_treatment_parameters_blgr.csv", row.names = FALSE)
...
dir.create("figures/predicted_abundance/timber/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/timber/blgr/timber_grass_cover_blgr.png", width = 4, height = 4)
...
dir.create("figures/predicted_abundance/rx_fire_young/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_young/blgr/rx_fire_young_grass_cover_blgr.png", width = 4, height = 5)
...
dir.create("figures/predicted_abundance/rx_fire_sec_growth/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_sec_growth/blgr/rx_fire_sec_growth_grass_cover_blgr.png", width = 4, height = 4)


#repeat for shrub cover
shrub_cover_range <- seq(min(umf_blgr@siteCovs$shrub_cover), max(umf_blgr@siteCovs$shrub_cover), length.out = 100)

newdata_shrub_cover <- data.frame(
  treatment = factor(treatment_levels, levels = treatment_levels),
  shrub_cover = shrub_cover_range,
  grass_cover = mean(umf_blgr@siteCovs$grass_cover),
  forb_cover = mean(umf_blgr@siteCovs$forb_cover),
  grass_height = mean(umf_blgr@siteCovs$grass_height),
  shrub_height = mean(umf_blgr@siteCovs$shrub_height)
)

predictions_shrub_cover <- predict(rn_model_t_blgr, newdata_shrub_cover, type = "state")
...
#save to figures/predicted_abundance/mine
dir.create("figures/predicted_abundance/mine/blgr")
ggsave("figures/predicted_abundance/mine/blgr/mine_shrub_cover_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/timber
dir.create("figures/predicted_abundance/timber/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/timber/blgr/timber_shrub_cover_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_young
dir.create("figures/predicted_abundance/rx_fire_young/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_young/blgr/rx_fire_young_shrub_cover_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_sec_growth
dir.create("figures/predicted_abundance/rx_fire_sec_growth/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_sec_growth/blgr/rx_fire_sec_growth_shrub_cover_blgr.png", width = 4, height = 4)

#repeat for forb cover

forb_cover_range <- seq(min(umf_blgr@siteCovs$forb_cover), max(umf_blgr@siteCovs$forb_cover), length.out = 100)
...
predictions_forb_cover <- predict(rn_model_t_blgr, newdata_forb_cover, type = "state")
...
#save to figures/predicted_abundance/mine
dir.create("figures/predicted_abundance/mine/blgr")
ggsave("figures/predicted_abundance/mine/blgr/mine_forb_cover_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/timber
dir.create("figures/predicted_abundance/timber/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/timber/blgr/timber_forb_cover_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_young
dir.create("figures/predicted_abundance/rx_fire_young/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_young/blgr/rx_fire_young_forb_cover_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_sec_growth
dir.create("figures/predicted_abundance/rx_fire_sec_growth/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_sec_growth/blgr/rx_fire_sec_growth_forb_cover_blgr.png", width = 4, height = 4)

#repeat for shrub height

shrub_height_range <- seq(min(umf_blgr@siteCovs$shrub_height), max(umf_blgr@siteCovs$shrub_height), length.out = 100)
...
predictions_shrub_height <- predict(rn_model_t_blgr, newdata_shrub_height, type = "state")
...
#save to figures/predicted_abundance/mine
dir.create("figures/predicted_abundance/mine/blgr")
ggsave("figures/predicted_abundance/mine/blgr/mine_shrub_height_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/timber
dir.create("figures/predicted_abundance/timber/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/timber/blgr/timber_shrub_height_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_young
dir.create("figures/predicted_abundance/rx_fire_young/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_young/blgr/rx_fire_young_shrub_height_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_sec_growth
dir.create("figures/predicted_abundance/rx_fire_sec_growth/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_sec_growth/blgr/rx_fire_sec_growth_shrub_height_blgr.png", width = 4, height = 4)


# Repeat for grass height

grass_height_range <- seq(min(umf_blgr@siteCovs$grass_height), max(umf_blgr@siteCovs$grass_height), length.out = 100)
...
predictions_grass_height <- predict(rn_model_t_blgr, newdata_grass_height, type = "state")
...
#save to figures/predicted_abundance/mine
dir.create("figures/predicted_abundance/mine/blgr")
ggsave("figures/predicted_abundance/mine/blgr/mine_grass_height_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/timber
dir.create("figures/predicted_abundance/timber/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/timber/blgr/timber_grass_height_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_young
dir.create("figures/predicted_abundance/rx_fire_young/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_young/blgr/rx_fire_young_grass_height_blgr.png", width = 4, height = 4)
...
#save to figures/predicted_abundance/rx_fire_sec_growth
dir.create("figures/predicted_abundance/rx_fire_sec_growth/blgr", showWarnings = FALSE)
ggsave("figures/predicted_abundance/rx_fire_sec_growth/blgr/rx_fire_sec_growth_grass_height_blgr.png", width = 4, height = 4)
