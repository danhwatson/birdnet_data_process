...
# read in data
data = read.csv('data/val_csv/val_wevi.csv')  
...
sp_code = data.frame(sp_code = 'WEVI')
...
png("figures/aos_pres/thresholds_conf_wevi.png", width = output_width, height = output_height, units = "in", res = output_dpi)
...
png("figures/aos_pres/thresholds_logit_wevi.png", width = output_width, height = output_height, units = "in", res = output_dpi)
