...
rn_model_t_nobo_forb_height <- occuRN( 
...
summary(rn_model_t_nobo_forb_height)


rn_model_t_nobo_temp <- occuRN( 
...
AICc(rn_model_t_nobo)
AICc(rn_model_t_nobo_forb_height)
AICc(rn_model_t_nobo_temp)
