...
rn_model_t_bacs_forb_height <- occuRN( 
...
summary(rn_model_t_bacs_forb_height)


rn_model_t_bacs_temp <- occuRN( 
...
AICc(rn_model_t_bacs)
AICc(rn_model_t_bacs_forb_height)
AICc(rn_model_t_bacs_temp)
